...
function FeatureGenerator:AddAtolls()
	...
	-- ThorHammerz 02/13/2015 
	-- Increase the number of atolls (testing needed), especially for the larger map sizes.
	-- TO DO: scale by water %.
	local worldsizes = {
		[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = 120,
		[GameInfo.Worlds.WORLDSIZE_TINY.ID] = 240,
		[GameInfo.Worlds.WORLDSIZE_SMALL.ID] = 400,
		[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = 550,
		[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = 750,
		[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = 1000,
	};
