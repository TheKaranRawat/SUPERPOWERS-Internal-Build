...
SELECT		Class, 	('UNIT_4UC_JAEGER'),	PrereqTech, 60, Cost, 	FaithCost, 	RequiresFaithPurchaseEnabled, Moves, HurryCostModifier,	CombatClass, Domain, DefaultUnitAI, ('TXT_KEY_4UC_JAEGER_DESC'),	('TXT_KEY_4UC_JAEGER_TEXT'),	('TXT_KEY_4UC_JAEGER_STRATEGY'),	('TXT_KEY_4UC_JAEGER_HELP'),	MilitarySupport, MilitaryProduction, Pillage, ObsoleteTech, AdvancedStartCost, GoodyHutUpgradeUnitClass, CombatLimit, XPValueAttack, XPValueDefense, Conscription, ('ART_DEF_UNIT_4UC_JAEGER'),	('UNITS_4UC_JAEGER_FLAG_ATLAS'), 	0,					0, 				('4UC_JAEGER_ATLAS'), 	MoveRate
