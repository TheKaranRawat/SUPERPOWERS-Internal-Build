...
SELECT	'UNIT_3CENTAUR',	Class,	  PrereqTech, 25, 2, Special, 45, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, Moves, 'UNITCOMBAT_HELICOPTER', Domain, 'UNITAI_FAST_ATTACK', 'TXT_KEY_UNIT_3CENTAUR_HELP','TXT_KEY_UNIT_3CENTAUR', 'TXT_KEY_UNIT_3CENTAUR_TEXT',	'TXT_KEY_UNIT_3CENTAUR_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_3CENTAUR',	0,					'3CENTAUR_FLAG',					  0, 				'3CENTAUR_ATLAS',	 MoveRate
