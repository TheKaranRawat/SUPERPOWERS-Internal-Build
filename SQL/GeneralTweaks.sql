...
UPDATE Worlds SET TradeRouteDistanceMod=150 WHERE Type='WORLDSIZE_STANDARD';
UPDATE Worlds SET TradeRouteDistanceMod=200 WHERE Type='WORLDSIZE_LARGE';
UPDATE Worlds SET TradeRouteDistanceMod=250 WHERE Type='WORLDSIZE_HUGE';
